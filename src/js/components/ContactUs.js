...
export default function Contact(props) {
    ...
    const onConfirm = () => {
        ...
        axios
            .get(
                "https://us-central1-talentresolve-2450f.cloudfunctions.net/sendMail",
            {
                params: {
                    email: email,
                    name: name,
        ...
        <Grid container direction="row">
            <Grid item container direction="column"style={{
                ...
                marginTop: matchesSM ? "1em" : matchesMD ? "5em" : 0
                  ...
                  lg={4} xl={3} alignItems={"center"} justify="center">
                <Grid item>
                    <Grid container direction="column">
                        <Grid item>
                            <Typography align={matchesMD ? "center" : undefined} variant={"h2"} style={{lineHeight: 1}}>Contact Us</Typography>
                            <Typography align={matchesMD ? "center" : undefined} variant={"body1"} style={{color: theme.palette.common.blue}}>We are waiting.</Typography>
                        </Grid>
                        ...
                        <Grid item container style={{ marginBottom: "2em"}}>
                            ...
                            <Grid item>
                                <Typography variant={"body1"} style={{color: theme.palette.common.blue, fontSize: "1rem"}}>
                                    <a
                                        href="mailto:rahulsingh336@gmail.com"
                                        style={{ textDecoration: "none", color: "inherit" }}
                                    >
