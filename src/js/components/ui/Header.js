...
//import logo from '../../assets/LogoTR.svg';
import logo from '../../assets/logo_without_symbol.svg';
            ...
            <ElevationScroll>
                <AppBar position="absolute" className={classes.appbar}>
                    <Toolbar disableGutters>
                        ...
                        <Grid container className={classes.brandName}>
                            <Grid item>
                                <Link href="/" component={LinkRouter}
                                      to={"/"} className={classes.customLink}>
